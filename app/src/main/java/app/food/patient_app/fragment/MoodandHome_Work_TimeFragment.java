...
public class MoodandHome_Work_TimeFragment extends Fragment {
    private static final String TAG = "MoodandHome_Work_TimeFr";
    View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_moodand_home__work__time, container, false);
        initialize();
        Clicked();
        webView(7);
    ...
    private void initialize() {
        ...
        btn_Seven_Days = mView.findViewById(R.id.btn_seven_day_moods_workhome_time);
        btn_Thirty_Days = mView.findViewById(R.id.btn_thirty_day_moods_workhome_time);
        btn_Ninty_Days = mView.findViewById(R.id.btn_ninty_day_moods_workhome_time);
        progressBar = mView.findViewById(R.id.progress_bar_moods_workhome_time);
    }
    ...
    private void webView(int day) {
        webViewGraph = mView.findViewById(R.id.webViewGraph_moods_workhome_time);
        ...
        Log.e(TAG, "webview Mood and Social Graph URL:- " + Constant.BASE_URL + "mood_and_work_home_time?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day=7");
        webViewGraph.loadUrl(Constant.BASE_URL + "mood_and_work_home_time?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day="+day);
    }
    //http://www.charmhdwallpapers.com/patient_app/mood_and_work_home_time?id=19&date=2019-05-17&day=30
