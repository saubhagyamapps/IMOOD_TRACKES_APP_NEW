...
public class WorkAndHomeGraphFragment extends Fragment {
    ...
    private void webView(int day) {
        ...
        Log.e(TAG, "webview Mood and Social Graph URL:- " + Constant.BASE_URL + "homeandwork_barchart?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day=7");
        webViewGraph.loadUrl(Constant.BASE_URL + "homeandwork_barchart?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day="+day);
    }
