...
public class StepCountGraphThreeFragment extends Fragment {
    ...
    private void initialization() {
        ...
        Log.e(TAG, "webview Graph URL:- " + Constant.BASE_URL + "stepchart?id=" + Constant.mUserId + "&date=" + Constant.currentDate()+"&day=90");
        webViewGraph.loadUrl(Constant.BASE_URL + "stepchart?id=" + Constant.mUserId + "&date=" + Constant.currentDate()+"&day=90");
