...
public class StepGraphViewPagerFragment extends Fragment {
    View mView;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new StepCountGraphFragment(), "Week");
        adapter.addFragment(new StepCountGraphTwoFragment(), "Month");
        adapter.addFragment(new StepCountGraphThreeFragment(), "3 Month");
