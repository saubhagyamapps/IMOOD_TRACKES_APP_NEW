...
public class SocialIntegrationFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mView = inflater.inflate(R.layout.socil_integration_fragment, container, false);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new CallLogsFragment(), "Today");
        adapter.addFragment(new CallLogsTwoFragment(), "Week");
        adapter.addFragment(new CallLogsThreeFragment(), "Month");
