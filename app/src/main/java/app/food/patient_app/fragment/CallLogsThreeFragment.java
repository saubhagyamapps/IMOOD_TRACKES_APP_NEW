...
public class CallLogsThreeFragment extends Fragment implements MessageListener {
    View mView;
    ...
    private void initializ() {
        ...
        txtTodayDate = (TextView) mView.findViewById(R.id.txtTodayDate);
    ...
    private void getTotalData() {
        Call<SocialItegrationModel> modelCall=Constant.apiService.getAllSocialData(Constant.mUserId,Constant.currentDate(),"30");
    ...
    private void getMonthlyUsage() {
        ...
        Call<GetSocialUsageListModel> socialusageListModelCall = Constant.apiService.CallSocialList(Constant.mUserId, Constant.currentDate(),"30");
