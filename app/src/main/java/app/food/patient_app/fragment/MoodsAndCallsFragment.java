...
public class MoodsAndCallsFragment extends Fragment {
    View mView;
    private WebView webViewGraph;
    private static final String TAG = "MoodsAndCallsFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_moods_and_calls, container, false);
        initialize();
        webView(7);
        Clicked();
    ...
    private void initialize() {
        ...
        btn_Seven_Days = mView.findViewById(R.id.btn_seven_day_moods_calls);
        btn_Thirty_Days = mView.findViewById(R.id.btn_thirty_day_moods_calls);
        btn_Ninty_Days = mView.findViewById(R.id.btn_ninty_day_moods_calls);
        progressBar = mView.findViewById(R.id.progress_bar_moods_calls);
    }
    ...
    private void webView(int day) {
        webViewGraph = mView.findViewById(R.id.webViewGraph_moods_calls);
        ...
        Log.e(TAG, "webview Mood and Social Graph URL:- " + Constant.BASE_URL + "moodandcallscount?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day=7");
        webViewGraph.loadUrl(Constant.BASE_URL + "moodandcallscount?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day="+day);
    }
//http://charmhdwallpapers.com/patient_app/moodandcallscount?id=19&date=2019-05-16&day=30
