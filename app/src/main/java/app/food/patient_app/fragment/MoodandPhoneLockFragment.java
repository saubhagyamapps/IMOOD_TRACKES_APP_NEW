...
public class MoodandPhoneLockFragment extends Fragment {
    private static final String TAG = "MoodandPhoneLockFragmen";
    View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_moodand_phone_lock, container, false);
        initialize();
        Clicked();
        webView(7);
    ...
    private void initialize() {
        ...
        btn_Seven_Days = mView.findViewById(R.id.btn_seven_day_moods_phone_lock);
        btn_Thirty_Days = mView.findViewById(R.id.btn_thirty_day_moods_phone_lock);
        btn_Ninty_Days = mView.findViewById(R.id.btn_ninty_day_moods_phone_lock);
        progressBar = mView.findViewById(R.id.progress_bar_moods_phone_lock);
    }
    ...
    private void webView(int day) {
        webViewGraph = mView.findViewById(R.id.webViewGraph_moods_phone_lock);
        ...
        Log.e(TAG, "webview Mood and Social Graph URL:- " + Constant.BASE_URL + "moodandphoneunlocks?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day=7");
        webViewGraph.loadUrl(Constant.BASE_URL + "moodandphoneunlocks?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day="+day);
    }
        //http://charmhdwallpapers.com/patient_app/moodandphoneunlocks?id=19&date=2019-05-16&day=30
