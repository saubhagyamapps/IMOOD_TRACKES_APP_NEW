...
public class CallLogsTwoFragment extends Fragment implements MessageListener {
    View mView;
    ...
    private void getTotalData() {
        Call<SocialItegrationModel> modelCall=Constant.apiService.getAllSocialData(Constant.mUserId,Constant.currentDate(),"7");
    ...
    private void getMonthlyUsage() {
        ...
        Call<GetSocialUsageListModel> socialusageListModelCall = Constant.apiService.CallSocialList(Constant.mUserId, Constant.currentDate(),"7");
