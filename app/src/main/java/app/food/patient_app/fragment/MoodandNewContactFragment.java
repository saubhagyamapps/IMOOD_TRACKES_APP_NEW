...
public class MoodandNewContactFragment extends Fragment {
    private static final String TAG = "MoodandNewContactFragme";
    View mView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView =  inflater.inflate(R.layout.fragment_moodand_new_contact, container, false);
        initialize();
        Clicked();
        webView(7);
    ...
    private void initialize() {
        ...
        btn_Seven_Days = mView.findViewById(R.id.btn_seven_day_moods_contact);
        btn_Thirty_Days = mView.findViewById(R.id.btn_thirty_day_moods_contact);
        btn_Ninty_Days = mView.findViewById(R.id.btn_ninty_day_moods_contact);
        progressBar = mView.findViewById(R.id.progress_bar_moods_contact);
    }
    ...
    private void webView(int day) {
        webViewGraph = mView.findViewById(R.id.webViewGraph_moods_contact);
        ...
        Log.e(TAG, "webview Mood and Social Graph URL:- " + Constant.BASE_URL + "moodandcontact?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day=7");
        webViewGraph.loadUrl(Constant.BASE_URL + "moodandcontact?id=" + Constant.mUserId + "&date=" + Constant.currentDate() + "&day="+day);
    }
//http://charmhdwallpapers.com/patient_app/moodandcontact?id=19&date=2019-05-16&day=30
